...
export const SPECIALIZATIONS = [
  ...
  },
  {
    ...
    name: "علوم الحاسب",
    en: "Computer Science",
    description: "دراسة البرمجة وعلوم الحاسب وتطوير البرمجيات والتقنيات الحديثة.",
    icon: "Database",
  },
  {
    id: "engineering",
    name: "الهندسة",
    en: "Engineering",
    description: "تخصصات هندسية متنوعة تشمل الميكانيكا والميكاترونكس والكيمياء والاتصالات والمدني والعمارة والطبية.",
    icon: "TrendingUp",
  },
] as const;
